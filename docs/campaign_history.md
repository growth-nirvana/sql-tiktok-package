...
This table implements a Slowly Changing Dimension (SCD) Type 2 pattern for TikTok Campaigns, tracking historical changes to campaign attributes over time. It maintains a complete history of campaign changes while providing an easy way to access the current state of each campaign.

## Table Structure

| Column         | Type      | Description                                                      |
|---------------|-----------|------------------------------------------------------------------|
| campaign_id    | STRING    | The unique identifier for the TikTok Campaign                    |
...
- The table maintains referential integrity with other TikTok Ads tables through the `campaign_id` field 