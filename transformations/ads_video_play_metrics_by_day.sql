-- ads_video_play_metrics_by_day_report
-- Batch-based daily snapshot table for TikTok Ads Video Play Metrics
{% assign target_dataset = vars.target_dataset_id %}
{% assign target_table_id = 'ads_video_play_metrics_by_day_report' %}

{% assign source_dataset = vars.source_dataset_id %}
{% assign source_table_id = 'ads_video_play_metrics_by_day' %}
...
IF table_exists THEN
  ...
  CREATE TABLE IF NOT EXISTS `{{target_dataset}}.{{target_table_id}}` (
    ...
    _gn_id STRING,
    tenant STRING,
    video_play_actions FLOAT64,
    video_watched_2s FLOAT64,
    video_watched_6s FLOAT64,
    average_video_play FLOAT64,
    average_video_play_per_user FLOAT64,
    video_views_p25 FLOAT64,
    video_views_p50 FLOAT64,
    video_views_p75 FLOAT64,
    video_views_p100 FLOAT64,
  ...
  BEGIN TRANSACTION;
    ...
    SELECT
      ...
      tenant,
      SAFE_CAST(video_play_actions AS FLOAT64),
      SAFE_CAST(video_watched_2s AS FLOAT64),
      SAFE_CAST(video_watched_6s AS FLOAT64),
      SAFE_CAST(average_video_play AS FLOAT64),
      SAFE_CAST(average_video_play_per_user AS FLOAT64),
      SAFE_CAST(video_views_p25 AS FLOAT64),
      SAFE_CAST(video_views_p50 AS FLOAT64),
      SAFE_CAST(video_views_p75 AS FLOAT64),
      SAFE_CAST(video_views_p100 AS FLOAT64),
