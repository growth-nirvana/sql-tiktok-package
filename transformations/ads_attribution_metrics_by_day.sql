-- ads_attribution_metrics_by_day_report
-- Batch-based daily snapshot table for TikTok Ads Attribution Metrics
{% assign target_dataset = vars.target_dataset_id %}
{% assign target_table_id = 'ads_attribution_metrics_by_day_report' %}

{% assign source_dataset = vars.source_dataset_id %}
{% assign source_table_id = 'ads_attribution_metrics_by_day' %}
...
IF table_exists THEN
  ...
  CREATE TABLE IF NOT EXISTS `{{target_dataset}}.{{target_table_id}}` (
    ...
    _gn_id STRING,
    tenant STRING,
    vta_app_install FLOAT64,
    vta_conversion FLOAT64,
    cost_per_vta_conversion FLOAT64,
    vta_registration FLOAT64,
    cost_per_vta_registration FLOAT64,
    vta_purchase FLOAT64,
    cost_per_vta_purchase FLOAT64,
    cta_app_install FLOAT64,
    cta_conversion FLOAT64,
    cost_per_cta_conversion FLOAT64,
    cta_registration FLOAT64,
    cost_per_cta_registration FLOAT64,
    cta_purchase FLOAT64,
    cost_per_cta_purchase FLOAT64,
  ...
  BEGIN TRANSACTION;
    ...
    SELECT
      ...
      tenant,
      SAFE_CAST(vta_app_install AS FLOAT64),
      SAFE_CAST(vta_conversion AS FLOAT64),
      SAFE_CAST(cost_per_vta_conversion AS FLOAT64),
      SAFE_CAST(vta_registration AS FLOAT64),
      SAFE_CAST(cost_per_vta_registration AS FLOAT64),
      SAFE_CAST(vta_purchase AS FLOAT64),
      SAFE_CAST(cost_per_vta_purchase AS FLOAT64),
      SAFE_CAST(cta_app_install AS FLOAT64),
      SAFE_CAST(cta_conversion AS FLOAT64),
      SAFE_CAST(cost_per_cta_conversion AS FLOAT64),
      SAFE_CAST(cta_registration AS FLOAT64),
      SAFE_CAST(cost_per_cta_registration AS FLOAT64),
      SAFE_CAST(cta_purchase AS FLOAT64),
      SAFE_CAST(cost_per_cta_purchase AS FLOAT64),
